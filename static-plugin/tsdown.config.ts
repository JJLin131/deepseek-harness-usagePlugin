 ...
 *  tsdown/rolldown 0.22.2 没有装饰器转换选项，故宿主半不走 tsdown。
 *
 ...
 *
 * 注：tsdown 0.22.2 中 `external` 已废弃，改用 `deps.neverBundle`。
 */
...
export default defineConfig({
  ...
  outputOptions: {
    ...
    banner: `window.__ModuleLoader__.load({ id: "@dsh-usage-panel", factory: (require) => {`,
