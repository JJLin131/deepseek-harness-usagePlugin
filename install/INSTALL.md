...
安装后默认在**右下角**显示一个悬浮胶囊，**鼠标悬停自动展开**完整用量信息；
可在面板内切换为右上角悬浮或输入框下方（对话栏）。
...
1. 鼠标移到右下角（或右上角）的「API 用量」胶囊上 → 自动展开完整面板；移开自动收起；
   点击胶囊也可手动展开/收起。
2. 面板内：
