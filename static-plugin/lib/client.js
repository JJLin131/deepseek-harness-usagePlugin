...
`;
		...
		function Detail(props) {
			...
			if (view === "settings") {
				...
				}, react.default.createElement(IconClock, null), react.default.createElement("span", null, "更新于 " + fmtTime(data.lastUpdated)), data && data.error ? react.default.createElement("span", { className: "dshup-err" }, data.error) : null));
			}
		...
		function apply(ctx) {
			api = ctx.get("connection").api.usage;
			injectStyles(CSS);
			const saved = readSaved();
			...
			ctx.interval(refreshConfig, 30 * 1e3);
